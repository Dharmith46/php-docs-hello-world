...
<?php $__env->startSection('employer_login'); ?>
        ...
        <div class="col-lg-6 col-md-8 col-sm-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form  action="<?php echo e(route('employer.login')); ?>" method="post">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('master_layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aligned_version_2\resources\views/employer/employer_login.blade.php ENDPATH**/ ?>