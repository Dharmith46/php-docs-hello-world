...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('panel/css/bootstrap.css')); ?>">
        

        <!-- Related styles of various javascript plugins -->
        <link rel="stylesheet" href="<?php echo e(asset('panel/css/plugins.css')); ?>">

        <!-- The main stylesheet of this template. All Bootstrap overwrites are defined in here -->
        <link rel="stylesheet" href="<?php echo e(asset('panel/css/main.css')); ?>">

        <!-- Load a specific file here from css/themes/ folder to alter the default theme of the template -->

        <!-- The themes stylesheet of this template (for using specific theme color in individual elements - must included last) -->
        <link rel="stylesheet" href="<?php echo e(asset('panel/css/themes.css')); ?>">
        <!-- END Stylesheets -->

        <!-- Modernizr (browser feature detection library) & Respond.js (Enable responsive CSS code on browsers that don't support it, eg IE8) -->
        <script src="<?php echo e(asset('panel/js/vendor/modernizr-respond.min.js')); ?>"></script>
    </head>
    ...
    <body>
                ...
                <ul id="widgets" class="navbar-nav-custom pull-right">
                    ...
                    <li class="dropdown pull-right dropdown-user">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="<?php echo e(route('admin.logout')); ?>"><i class="fa fa-lock"></i> Log out</a>
                            </li>
                        </ul>
                    </li>
                    <!-- END User Menu -->
            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                            <li>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="active"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>
                            <!-- <li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(route('admin.AllEmployer')); ?>"><i class="fa fa-file-text"></i>All Employer</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.jobslots')); ?>"><i class="fa fa-exclamation-triangle"></i>Job Slots</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.license')); ?>"><i class="fa fa-magic"></i>All Licences</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.allmessage')); ?>"><i class="fa fa-flask"></i>All Messages</a>
                                    </li>
                                    
                                    <li>
                                        <a href="<?php echo e(route('admin.allteam_member')); ?>"><i class="fa fa-flask"></i>Team Members & Admin Users</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.employer_interview_tracking')); ?>"><i class="fa fa-flask"></i>Employer Interview Tracking</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(route('admin.AllCandidate')); ?>"><i class="fa fa-file-text"></i>All Candidates</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.CandidateAssesment')); ?>"><i class="fa fa-exclamation-triangle"></i>Candidate Assesment</a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(route('admin.candidate_interview')); ?>"><i class="fa fa-magic"></i>Candidate Interview Tracking</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="<?php echo e(route('admin.AssesmentCreation')); ?>"><i class="fa fa-file-text"></i>Assesment Creation</a>
                                    </li>
                ...
                <div id="page-content">
                    ...
                    <?php echo $__env->yieldContent('allemployer'); ?>
                    <?php echo $__env->yieldContent('job_slots'); ?>
                    <?php echo $__env->yieldContent('all_license'); ?>
                    <?php echo $__env->yieldContent('all_messages'); ?>
                    <?php echo $__env->yieldContent('all_team_member'); ?>
                    <?php echo $__env->yieldContent('interview_tracking'); ?>

                    <?php echo $__env->yieldContent('allcandidate'); ?>
                    <?php echo $__env->yieldContent('candidate_assesment'); ?>
                    <?php echo $__env->yieldContent('candidate_interview_tracking'); ?>

                    <?php echo $__env->yieldContent('assesment_creation'); ?>
        ...
        <!-- Bootstrap.js -->
        <script src="<?php echo e(asset('panel/js/vendor/bootstrap.min.js')); ?>"></script>

        <!-- Jquery plugins and custom javascript code -->
        <script src="<?php echo e(asset('panel/js/plugins.js')); ?>"></script>
        <script src="<?php echo e(asset('panel/js/main.js')); ?>"></script>
...
</html><?php /**PATH C:\xampp\htdocs\aligned_version_2\resources\views/master_layout/admin_master.blade.php ENDPATH**/ ?>