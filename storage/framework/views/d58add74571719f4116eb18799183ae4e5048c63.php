...
<?php $__env->startSection('candidate_landing'); ?>
...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <nav class="header-nav ms-auto">
    <ul class="d-flex align-items-center">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('candidate.help')); ?>">Help Center</a>
      </li>
...
<div class="row featurette section-one text-center align-items-center py-4 bg-white">
  ...
  <div class="col-md-5">
    <img src="<?php echo e(asset('assets/img/unlock.png')); ?>" alt="Unlock your potential" class="img-fluid mx-auto"
...
<div class="row featurette section-two text-center align-items-center py-4" style="background-color: #c3ebfd">
  ...
  <div class="col-md-5 order-md-1">
    <img src="<?php echo e(asset('assets/img/applysmartly.png')); ?>" alt="Apply smartly" class="img-fluid mx-auto"
      style="max-width: 100%; height: auto" />
  </div>
</div>
...
<div class="row featurette section-three text-center align-items-center py-4 bg-white">
  ...
  <div class="col-md-5">
    <img src="<?php echo e(asset('assets/img/skill.png')); ?>" alt="Skill Guidance" class="img-fluid mx-auto"
      style="max-width: 100%; height: auto" />
  </div>
</div>
...
<?php echo $__env->make('master_layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aligned_version_2\resources\views/candidate/candidate_landing.blade.php ENDPATH**/ ?>