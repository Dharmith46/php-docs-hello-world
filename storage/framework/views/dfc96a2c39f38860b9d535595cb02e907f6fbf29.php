...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="assesment.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="job.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="apptrack.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="pages-insights.html">
...
</html><?php /**PATH C:\xampp\htdocs\aligned\resources\views/master_layout/candidate_master.blade.php ENDPATH**/ ?>