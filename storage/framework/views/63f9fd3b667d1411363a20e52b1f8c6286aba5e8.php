...
<body>
  ...
  <?php echo $__env->yieldContent('employer_login'); ?>
  <?php echo $__env->yieldContent('candidate_login'); ?>
  <?php echo $__env->yieldContent('admin_login'); ?>
  <?php echo $__env->yieldContent('welcome'); ?>
  <?php echo $__env->yieldContent('employer_landing'); ?>
  <?php echo $__env->yieldContent('candidate_landing'); ?>
  <?php echo $__env->yieldContent('all_jobs'); ?>
  <?php echo $__env->yieldContent('candidate_help'); ?>
  <?php echo $__env->yieldContent('employer_help'); ?>
  <?php echo $__env->yieldContent('employer_pricing'); ?>
...
</html><?php /**PATH C:\xampp\htdocs\aligned_version_2\resources\views/master_layout/master.blade.php ENDPATH**/ ?>