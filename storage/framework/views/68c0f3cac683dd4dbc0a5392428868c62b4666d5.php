    ...
    <div class="row">
      ...
      <div class="col-md-6 d-flex align-items-center justify-content-center">
        <div class="embed-responsive embed-responsive-16by9" style="max-width: 100%; height: auto;">
          <iframe class="embed-responsive-item" src="<?php echo e(asset('assets/img/hiring.mp4')); ?>" allowfullscreen
...
<?php echo $__env->make('master_layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aligned\resources\views/welcome.blade.php ENDPATH**/ ?>