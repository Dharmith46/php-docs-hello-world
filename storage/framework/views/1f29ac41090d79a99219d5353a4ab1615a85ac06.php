...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    <ul class="sidebar-nav" id="sidebar-nav">
      <li class="nav-item">
        <a class="nav-link collapsed" href="Team Page.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Team Assessment.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Employer Job Posting.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ApplicantReview-Job Applicants.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="ApplicantReview-Applicant Tracking.html">
          <i class="fas fa-file-alt"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="Talent Search.html">
...
</html><?php /**PATH C:\xampp\htdocs\aligned\resources\views/master_layout/employer_master.blade.php ENDPATH**/ ?>